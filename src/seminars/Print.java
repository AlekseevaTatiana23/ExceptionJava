 ...
 *Напишите свой код в методе subArrays класса seminars.Answer. Метод subArrays принимает на вход два параметра:
 * int[] a - первый массив
 * int[] b - второй массив
 * Пример
 * a = new int[]{4, 5, 6}; b = new int[]{1, 2, 3};
 * Вывод: [3, 3, 3]
 * a = new int[]{4, 5, 6}; b = new int[]{1, 2, 3, 5};
 * Вывод: [0]
 */
